        ...
        return(
            <div className="container">
                ...
                <div className="form-group">
                    ...
                    <input type="email" name="email" ref={ref => this.email = ref} className="form-control" id="exampleInputEmail1" placeholder="nome@email.com" />                    
                </div>
                <div className="form-group">
                    ...
                    {this.state.erro && <small id="emailHelp" className="form-text text-muted">Email e/ou Senha incorretos!</small>}
                </div>   
